...
const ReelsScreen = () => {
  ...
  const containerHeight = useMemo(() => {
    if (screenHeight > 0 && topBarHeight > 0) {
      const bottomBarHeight = fh(14);
      const height = screenHeight - bottomBarHeight - topBarHeight;
  ...
  return (
    ...
    >
      ...
      {/* 🔹 TopBar Overlay */}
      <View style={[styles.topBarWrap, { paddingTop: insets.top }]} onLayout={(e) => setTopBarHeight(e.nativeEvent.layout.height)} >
