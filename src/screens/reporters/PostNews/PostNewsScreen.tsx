...
const styles = StyleSheet.create({
  ...
  uploadPlaceholder: { color: Colors.mediumGray },
  helperText: {
    position: "absolute",
    bottom: fh(6),
    right: fw(20),
  ...
  removePillText: { color: "#fff", fontSize: ff(12) },
  ...
  submitText: { color: Colors.textcolor, fontSize: ff(14) },
  dropdownWrap: { position: "relative", marginBottom: fh(12), right: 5 },
  prefRowBase: {
    height: fh(46),
    width: fw(346),
    borderRadius: fw(6),
  ...
  prefTitle: { fontSize: ff(14) },
  chev: { color: Colors.textcolor, fontSize: ff(18) },
  dropdownPanel: {
    position: "absolute",
    top: fh(50),
    left: 0,
  ...
  dropdownText: { fontSize: ff(14) },
  langButton: {
    paddingVertical: fh(8),
    paddingHorizontal: fw(20),
    marginHorizontal: fw(6),
    borderRadius: fw(20),
    backgroundColor: Colors.deepPurple,
    borderWidth: 1,
