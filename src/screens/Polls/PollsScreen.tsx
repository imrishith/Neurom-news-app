...
const VerticalPollsCarousel = () => {
  ...
  const getItemHeight = () => {
    ...
    return SCREEN_HEIGHT * 0.7; // 70% of screen height
  };
  ...
  const CARD_HEIGHT = getItemHeight();
        ...
        <View style={styles.carouselWrapper}>
          {loading ? (
            <Carousel
              ...
              horizontal={false}
              itemSpacing={fh(20)}
              snapToInterval={CARD_HEIGHT + fh(20)}
              windowSize={3}
            ...
            <Carousel
              ...
              getItemLayout={(data, index) => ({
                length: CARD_HEIGHT + fh(20),
                offset: (CARD_HEIGHT + fh(20)) * index,
                index,
              })}
